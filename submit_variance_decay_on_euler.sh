...
do
	...
	do
	    for time_averaged in '' '_time_integratedd';
	    do
		...
		submit python python/estimate_variance_decay.py \
		       --input_basename ${datapath}experiments_full_time_average/kh/p0_06/N{resolution}/kh_functional_${time_averaged}_${functional_filename}_${file_time}.nc \
		...
		submit python python/estimate_variance_decay.py \
		       --input_basename ${datapath}experiments_full_time_average/cloudshock/p0_06/N{resolution}/cloudshock_functional_${time_averaged}${functional_filename}_${file_time}.nc \
		       --starting_resolution 64 \
		       --max_resolution 1024 \
		...
		submit python python/estimate_variance_decay.py \
		       --input_basename ${datapath}experiments_full_time_average/rm/p0_06/N{resolution}/rm_functional_${time_averaged}${functional_filename}_${file_time}.nc \
		       --starting_resolution 64 \
		       --max_resolution 1024 \
		...
		submit python python/estimate_variance_decay.py \
		       --input_basename ${datapath}experiments_full_time_average/shockvortex/p0_06/N{resolution}/shockvortex_functional_${time_averaged}${functional_filename}_${file_time}.nc \
		       --starting_resolution 64 \
		       --max_resolution 1024 \
		...
		do
		    submit python python/estimate_variance_decay.py \
			   --input_basename ${datapath}experiments_full_time_average/fbb/H${H//./_}/N{resolution}/euler_fbb_functional_${time_averaged}${functional_filename}_${file_time}.nc \
			   --starting_resolution 64 \
			   --max_resolution 1024 \
